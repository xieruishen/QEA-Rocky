// This code completes the surviver challenge of the Robolympics. The code uses angle, velocity and distance control to make the robot stay in a 2' by 2' square.
...
void updatePWMs(float totalDistanceLeft, float totalDistanceRight, float vL, float vR, float angleRad, float angleRadAccum, float delta_t) {
    ...
    float dist = K*(totalDistanceLeft + totalDistanceRight)/2.0;
    thetaAccum += (-angleRad - dist)*delta_t;
